...
void CalculateDistortPara(std::vector<std::vector<double>> points, std::vector<double> InnInitial, int nWidth_, int nHight_, std::vector<double> &Inn)
{
...
void CalculateDistortParaInv(std::vector<std::vector<double>> points, std::vector<double> InnInitial, int nWidth_, int nHight_, std::vector<double> &InnInv)
{
    int nWidth = nWidth_, nHight = nHight_; 
    double lamdaInitial, FocalLengthInitial;
    double frectified = InnInitial[4];
    ...
    EstimateFInv(points,InnInitial,nWidth,nHight,pointsForInitial,FocalLengthInitial,lamdaInitial);
